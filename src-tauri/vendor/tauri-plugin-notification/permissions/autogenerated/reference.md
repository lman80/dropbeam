...
`notification:allow-watch-actions`

</td>
<td>

Enables the watch_actions command without any pre-configured scope.
...
`notification:deny-watch-actions`

</td>
<td>

Denies the watch_actions command without any pre-configured scope.
