...
//   dropbeamlink1:…  link-a-device code (new device shows) (link.rs PREFIX)
//   dropbeamjoin1:…  join-my-account code (device with the account shows) (link.rs JOIN_PREFIX)
...
const EMBEDDED = /(dropbeamlink1:|dropbeamjoin1:|dropbeamf1:|dropbeam1:|dropbeam:)([A-Za-z0-9_-]{8,})|(direct)(eyJ[A-Za-z0-9_-]{8,})/i
